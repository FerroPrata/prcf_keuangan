    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <p style="margin: 10px 0 0 0;">PRCF INDONESIA Financial Financial Management System</p>
            </div>
            <div class="content">
...
function send_notification_email($email, $subject, $message) {
    try {
        ...
        if (!defined('SMTP_HOST') || !defined('SMTP_PORT') || !defined('SMTP_USER') || !defined('SMTP_PASS')) {
            ...
            error_log("   💡 Enable SMTP in config.php to send actual emails");
...
function send_otp_whatsapp($phone, $otp) {
    try {
        ...
        $message .= "PRCF INDONESIA Financial Financial Management System";
